...
Tags: responsive css,responsive custom style, custom css, css editor, wpwox, easy responsive css editor, responsive css breakpoints
Requires at least: 3
Tested up to: 4.4.1
Stable tag: 1.0
...
Once you have installed the plugin and activated it, you can start creating breakpoints and adding css rules to them.

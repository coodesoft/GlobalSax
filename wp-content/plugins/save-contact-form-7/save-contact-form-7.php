...
/*function to filter data from selected field*/

function nimble_filter_by_field($filterby, $field){
$results = $wpdb->get_var( "SELECT * FROM {$wpdb->prefix}options WHERE ". $filterby ." = " . $field);
}
?>
